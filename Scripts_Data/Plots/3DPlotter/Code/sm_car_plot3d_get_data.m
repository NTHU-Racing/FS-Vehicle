...
simTime             = logsout_VehBus.Values.WhlL1.xyz.Time;
tireFx  = [...
    squeeze(logsout_VehBus.Values.WhlL1.Fx.Data) ...
    squeeze(logsout_VehBus.Values.WhlR1.Fx.Data) ...
    squeeze(logsout_VehBus.Values.WhlL2.Fx.Data) ...
    squeeze(logsout_VehBus.Values.WhlR2.Fx.Data)];

tireFy  = [...
    squeeze(logsout_VehBus.Values.WhlL1.Fy.Data) ...
    squeeze(logsout_VehBus.Values.WhlR1.Fy.Data) ...
    squeeze(logsout_VehBus.Values.WhlL2.Fy.Data) ...
    squeeze(logsout_VehBus.Values.WhlR2.Fy.Data)];

tireFz  = [...
    squeeze(logsout_VehBus.Values.WhlL1.Fz.Data) ...
    squeeze(logsout_VehBus.Values.WhlR1.Fz.Data) ...
    squeeze(logsout_VehBus.Values.WhlL2.Fz.Data) ...
    squeeze(logsout_VehBus.Values.WhlR2.Fz.Data)];

% Tire position
tirePx =  [...
    logsout_VehBus.Values.WhlL1.xyz.Data(:,1) ...
    logsout_VehBus.Values.WhlR1.xyz.Data(:,1) ...
    logsout_VehBus.Values.WhlL2.xyz.Data(:,1) ...
    logsout_VehBus.Values.WhlR2.xyz.Data(:,1) ...
    ];

tirePy =  [...
    logsout_VehBus.Values.WhlL1.xyz.Data(:,2) ...
    logsout_VehBus.Values.WhlR1.xyz.Data(:,2) ...
    logsout_VehBus.Values.WhlL2.xyz.Data(:,2) ...
    logsout_VehBus.Values.WhlR2.xyz.Data(:,2) ...
    ];

tirePz =  [...
    logsout_VehBus.Values.WhlL1.xyz.Data(:,3) ...
    logsout_VehBus.Values.WhlR1.xyz.Data(:,3) ...
    logsout_VehBus.Values.WhlL2.xyz.Data(:,3) ...
    logsout_VehBus.Values.WhlR2.xyz.Data(:,3) ...
    ];
...
wheelAngles = [ ...
    -squeeze(logsout_VehBus.Values.Susp.SuspA1.WhlL.aToe.Data) ...
     squeeze(logsout_VehBus.Values.Susp.SuspA1.WhlR.aToe.Data) ...
    -squeeze(logsout_VehBus.Values.Susp.SuspA2.WhlL.aToe.Data) ...
     squeeze(logsout_VehBus.Values.Susp.SuspA2.WhlR.aToe.Data)]*pi/180;
...
wheelCamber = [ ...
    -squeeze(logsout_VehBus.Values.Susp.SuspA1.WhlL.aCamber.Data) ...
     squeeze(logsout_VehBus.Values.Susp.SuspA1.WhlR.aCamber.Data) ...
    -squeeze(logsout_VehBus.Values.Susp.SuspA2.WhlL.aCamber.Data) ...
     squeeze(logsout_VehBus.Values.Susp.SuspA2.WhlR.aCamber.Data)]*pi/180;
